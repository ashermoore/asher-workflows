...
- **Medium** (optional): The delivery format. Look for "for email", "for landing page", "for in-person", "for presentation", "for cold call", etc. If not specified, default to conversational (spoken, face-to-face).
